...
const Cropper = props => (
  <View style={styles.container}>
    ...
    <Animated.View
      style={[
        styles.animation,
        styles.topSideAnimation,
        props.getTopSideStyle(),
      ]}
    ...
    <Animated.View
      style={[
        styles.animation,
        styles.leftSideAnimation,
        props.getLeftSideStyle(),
      ]}
    ...
    <Animated.View
      style={[
        styles.animation,
        styles.bottomSideAnimation,
        props.getBottomSideStyle(),
      ]}
    ...
    <Animated.View
      style={[
        styles.animation,
        styles.rightSideAnimation,
        props.getRightSideStyle(),
      ]}
    ...
    <Animated.View
      style={[
        styles.animation,
        styles.topLeftAnimation,
        props.getTopLeftStyle(),
      ]}
    ...
    <Animated.View
      style={[
        styles.animation,
        styles.bottomLeftAnimation,
        props.getBottomLeftStyle(),
      ]}
    ...
    <Animated.View
      style={[
        styles.animation,
        styles.bottomRightAnimation,
        props.getBottomRightStyle(),
      ]}
    ...
    <Animated.View
      style={[
        styles.animation,
        styles.topRightAnimation,
        props.getTopRightStyle(),
      ]}
      ...
      <View style={styles.gridRow}>
        ...
        <View style={styles.gridColumn}>
          <View
            style={[
              styles.borderDesign,
              {borderTopWidth: 3, alignSelf: 'center'},
            ]}
          />
        </View>
        <View style={styles.gridColumn}>
          <View
            style={[
              styles.borderDesign,
              {borderTopWidth: 3, borderRightWidth: 3, alignSelf: 'flex-end'},
            ]}
          />
        </View>
      </View>
      ...
      <View style={styles.gridRow}>
        <View style={[styles.gridColumn, {flexDirection: 'row'}]}>
          <View
            style={[
              styles.borderDesign,
              {borderLeftWidth: 3, alignSelf: 'center'},
            ]}
          />
        </View>
        <View style={styles.gridColumn} />
        <View style={[styles.gridColumn, {justifyContent: 'center'}]}>
          <View
            style={[
              styles.borderDesign,
              {borderRightWidth: 3, alignSelf: 'flex-end'},
            ]}
          />
        </View>
      </View>
      ...
      <View style={styles.gridRow}>
        ...
        <View style={[styles.gridColumn, {justifyContent: 'flex-end'}]}>
          <View
            style={[
              styles.borderDesign,
              {borderBottomWidth: 3, alignSelf: 'center'},
            ]}
          />
        </View>
        <View style={[styles.gridColumn, {justifyContent: 'flex-end'}]}>
